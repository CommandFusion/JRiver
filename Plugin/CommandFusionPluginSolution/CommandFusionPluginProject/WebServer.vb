...
Public Class WebHTTPServer
    ...
    Public Sub HandleConnection()
        ...
        ElseIf sRequestedFile.StartsWith("?getcurrentart") Then
            Dim currentFile As MediaCenter.IMJFileAutomation = Audio.GetCurrentFile
            If currentFile IsNot Nothing Then
                sPhysicalFilePath = currentFile.GetImageFile(MediaCenter.MJImageFileFlags.IMAGEFILE_DISPLAY)
            End If
        End If
